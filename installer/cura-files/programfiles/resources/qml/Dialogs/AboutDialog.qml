...
UM.Dialog
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@info:credit","Ultimaker Cura is developed by Ultimaker in cooperation with the community.\nUltimaker proudly uses the following open source projects:")
        font: UM.Theme.getFont("system")
        wrapMode: Text.WordWrap
