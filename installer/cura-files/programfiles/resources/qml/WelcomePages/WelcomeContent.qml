...
Item
{
    ...
    Column
    {
        ...
        Label
        {
            ...
            text: catalog.i18nc("@label", "Welcome to Gearbox Slicer")
        ...
        Label
        {
            ...
            text: catalog.i18nc("@text", "Please follow these steps to set up Gearbox Slicer. This will only take a few moments.")
            wrapMode: Text.Wrap
