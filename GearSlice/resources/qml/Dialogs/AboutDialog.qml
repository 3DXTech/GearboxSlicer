...
UM.Dialog
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@info:credit","Gearbo Slice is developed by Gearbox3D in cooperation with the community.\nGearbo Slice proudly uses the following open source projects:")
        font: UM.Theme.getFont("system")
        wrapMode: Text.WordWrap
