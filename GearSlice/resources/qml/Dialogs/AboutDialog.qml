...
UM.Dialog
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@info:credit","E.G.G.S. is developed by Gearbox3D in cooperation with the community.\nE.G.G.S. proudly uses the following open source projects:")
        font: UM.Theme.getFont("system")
        wrapMode: Text.WordWrap
