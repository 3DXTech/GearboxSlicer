...
Item
{
    ...
    Column
    {
        ...
        Label
        {
            ...
            text: catalog.i18nc("@label", "Welcome to Open Kimono")
        ...
        Label
        {
            ...
            text: catalog.i18nc("@text", "Please follow these steps to set up Open Kimono. This will only take a few moments.")
            wrapMode: Text.Wrap
