...
Item
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@label", "Help us to improve Gearbox3D Slicer")
    ...
    Item
    {
        ...
        Column
        {
            ...
            Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: catalog.i18nc("@text", "Gearbox3D Slicer collects anonymous data to improve print quality and user experience, including:")
            ...
            Label
            {
                ...
                text:
                {
                    var t = catalog.i18nc("@text", "Data collected by Gearbox3D Slicer will not contain any personal information.")
